...
class BasicConvClassifier7(nn.Module):
    def __init__(
        self,
        num_classes: int,
        seq_len: int,
...
# Usage example
model = BasicConvClassifier7(num_classes=10, seq_len=100, in_channels=64, hid_dim=256, num_heads=8, num_layers=12, ff_dim=512)
